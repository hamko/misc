...
template<size_t...> struct tseq{}; template<size_t N, size_t... Is> struct gen_tseq : gen_tseq<N-1, N-1, Is...>{}; template<size_t... Is> struct gen_tseq<0, Is...> : tseq<Is...>{};
template<class Ch, class Tr, class Tuple, size_t... Is>
void print_tuple(basic_ostream<Ch,Tr>& os, Tuple const& t, tseq<Is...>){ using s = int[]; (void)s{0, (void(os << (Is == 0? "" : ", ") << get<Is>(t)), 0)...}; }
template<class Ch, class Tr, class... Args> 
auto operator<<(basic_ostream<Ch, Tr>& os, tuple<Args...> const& t) -> basic_ostream<Ch, Tr>& { os << "("; print_tuple(os, t, gen_tseq<sizeof...(Args)>()); return os << ")"; }
