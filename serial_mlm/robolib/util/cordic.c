...
const int32_t arc[LOOP]={1005309, 593468, 313572, 159174, 79896, 39986, 19998, 9999, 4999, 2499, 1249, 624, 312, 156, 78};  //!<三角関数用arctanテーブル
const int32_t arch[LOOP]={703111, 326928, 160841, 80104, 40013, 20001, 10000, 5000, 2500, 1250, 625, 312, 156, 78, 39};     //!<双曲線関数用arctanhテーブル
